...
<div id="yearDiv">
	...
	Udgivelser <a href="alleudgivelser.php" style="color:#4f4f4f">2012</a> / 
...
<?php
	...
	for($i=0; $i<$numbPapers; $i++)
	{
		if($xml->paper[$i]->attributes()->folder == "4463")
		{
			...
			"<div class='coverDiv'>
			<center>
			<a href='$katalogLink' target='blank'>
			<img src='$katalog' onerror='this.src:'images/freakazoid.jpg''>
			</a>
			<center>
			</div>";
...
$(document).ready(function(){   
    $("img").each(function(index) {  
        $(this).error(function() {  
            $(this).unbind("error").attr("src", "/images/freakazoid.jpg"); // If you want to replace with any blank image.  
