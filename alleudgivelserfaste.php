...
<title>Alle faste udgivelser</title>
...
<div id="yearDiv">
	...
	<a href="alleudgivelserfaste.php" style="color:#4f4f4f">Faste udgivelser</a> / 
	<a href="alleudgivelserkommende.php">Kommende udgivelser</a>
	</h1>
...
<?php
	...
	{
		if(($xml->paper[$i]->attributes()->folder == "4634") || ($xml->paper[$i]->attributes()->folder == "4635"))
		{
